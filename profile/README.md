...
- **Richer regex syntax** — atomic groups, `\K`, recursive patterns, callouts, DFA matching
- **JIT compilation** — native machine code for significant speedups
- **Built-in ReDoS protection** — configurable match, depth, and heap limits
- **Cross-system consistency** — match behavior with Nginx, PHP, R, grep -P, and more
- **Drop-in `java.util.regex` API** — switch engines without rewriting code
- **Full PCRE2 API access** — 100% of the C API exposed to Java

## Get Started

Head over to the main repository for documentation, usage examples, and more:

**[alexey-pelykh/pcre4j](https://github.com/alexey-pelykh/pcre4j)** | [pcre4j.org](https://pcre4j.org/) | [Javadoc](https://javadoc.io/doc/org.pcre4j)

---

This project is brought to you by [Alexey Pelykh](https://github.com/alexey-pelykh) with a great gratitude to the PCRE library author [Philip Hazel](https://github.com/PhilipHazel) and its contributors.
